...
public class PShapedRecipe implements IRecipe
{
    ...
    public PShapedRecipe(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public PShapedRecipe func_92100_c()
    {
